...
public class NewOrderReply extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"NewOrderReply\",\"namespace\":\"com.cyanspring.avro.generate.trade.bean\",\"fields\":[{\"name\":\"objectType\",\"type\":\"int\"},{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"exchangeAccount\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"result\",\"type\":\"boolean\"},{\"name\":\"message\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"txId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public NewOrderReply(java.lang.Integer objectType, java.lang.String orderId, java.lang.String exchangeAccount, java.lang.Boolean result, java.lang.String message, java.lang.String txId) {
  ...
  /** Creates a new NewOrderReply RecordBuilder */
  public static com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder newBuilder() {
    return new com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder();
  }
  
  /** Creates a new NewOrderReply RecordBuilder by copying an existing Builder */
  public static com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder newBuilder(com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder other) {
    return new com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder(other);
  }
  
  /** Creates a new NewOrderReply RecordBuilder by copying an existing NewOrderReply instance */
  public static com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder newBuilder(com.cyanspring.avro.generate.trade.bean.NewOrderReply other) {
    return new com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder(other);
  }
  
  /**
   * RecordBuilder for NewOrderReply instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NewOrderReply>
    implements org.apache.avro.data.RecordBuilder<NewOrderReply> {
    ...
    private Builder() {
      super(com.cyanspring.avro.generate.trade.bean.NewOrderReply.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing NewOrderReply instance */
    private Builder(com.cyanspring.avro.generate.trade.bean.NewOrderReply other) {
            super(com.cyanspring.avro.generate.trade.bean.NewOrderReply.SCHEMA$);
      if (isValidValue(fields()[0], other.objectType)) {
        this.objectType = data().deepCopy(fields()[0].schema(), other.objectType);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'objectType' field */
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder setObjectType(int value) {
    ...
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder clearObjectType() {
    ...
    /** Sets the value of the 'orderId' field */
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder setOrderId(java.lang.String value) {
    ...
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder clearOrderId() {
      orderId = null;
    ...
    /** Sets the value of the 'exchangeAccount' field */
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder setExchangeAccount(java.lang.String value) {
    ...
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder clearExchangeAccount() {
    ...
    /** Sets the value of the 'result' field */
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder setResult(boolean value) {
    ...
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder clearResult() {
    ...
    /** Sets the value of the 'message' field */
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder setMessage(java.lang.String value) {
    ...
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder clearMessage() {
      message = null;
    ...
    /** Sets the value of the 'txId' field */
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder setTxId(java.lang.String value) {
    ...
    public com.cyanspring.avro.generate.trade.bean.NewOrderReply.Builder clearTxId() {
      txId = null;
    ...
    @Override
    public NewOrderReply build() {
      try {
        NewOrderReply record = new NewOrderReply();
