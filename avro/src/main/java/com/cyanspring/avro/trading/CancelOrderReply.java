...
public class CancelOrderReply extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public CancelOrderReply(java.lang.Integer objectType, java.lang.String orderId, java.lang.Boolean result, java.lang.String message, java.lang.String txId) {
  ...
  public static com.cyanspring.avro.trading.CancelOrderReply.Builder newBuilder() {
    return new com.cyanspring.avro.trading.CancelOrderReply.Builder();
  }
  
  /** Creates a new CancelOrderReply RecordBuilder by copying an existing Builder */
  public static com.cyanspring.avro.trading.CancelOrderReply.Builder newBuilder(com.cyanspring.avro.trading.CancelOrderReply.Builder other) {
    return new com.cyanspring.avro.trading.CancelOrderReply.Builder(other);
  }
  
  /** Creates a new CancelOrderReply RecordBuilder by copying an existing CancelOrderReply instance */
  public static com.cyanspring.avro.trading.CancelOrderReply.Builder newBuilder(com.cyanspring.avro.trading.CancelOrderReply other) {
    return new com.cyanspring.avro.trading.CancelOrderReply.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CancelOrderReply>
    ...
    private Builder() {
      super(com.cyanspring.avro.trading.CancelOrderReply.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cyanspring.avro.trading.CancelOrderReply.Builder other) {
      super(other);
    ...
    private Builder(com.cyanspring.avro.trading.CancelOrderReply other) {
            super(com.cyanspring.avro.trading.CancelOrderReply.SCHEMA$);
      if (isValidValue(fields()[0], other.objectType)) {
        this.objectType = data().deepCopy(fields()[0].schema(), other.objectType);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'objectType' field */
    public com.cyanspring.avro.trading.CancelOrderReply.Builder setObjectType(int value) {
    ...
    public com.cyanspring.avro.trading.CancelOrderReply.Builder clearObjectType() {
    ...
    /** Sets the value of the 'orderId' field */
    public com.cyanspring.avro.trading.CancelOrderReply.Builder setOrderId(java.lang.String value) {
    ...
    public com.cyanspring.avro.trading.CancelOrderReply.Builder clearOrderId() {
      orderId = null;
    ...
    /** Sets the value of the 'result' field */
    public com.cyanspring.avro.trading.CancelOrderReply.Builder setResult(boolean value) {
    ...
    public com.cyanspring.avro.trading.CancelOrderReply.Builder clearResult() {
    ...
    /** Sets the value of the 'message' field */
    public com.cyanspring.avro.trading.CancelOrderReply.Builder setMessage(java.lang.String value) {
    ...
    public com.cyanspring.avro.trading.CancelOrderReply.Builder clearMessage() {
      message = null;
    ...
    /** Sets the value of the 'txId' field */
    public com.cyanspring.avro.trading.CancelOrderReply.Builder setTxId(java.lang.String value) {
    ...
    public com.cyanspring.avro.trading.CancelOrderReply.Builder clearTxId() {
      txId = null;
