...
/**
 * Implement NamespaceContext interface.
 * This class is copied from XPathAPI (https://github.com/gioele/xpathapi-jaxp)
 */
public class NodeNamespaceContext implements NamespaceContext
{
	...
	/**
	 * Create a namespace based on root document's namespace attributes.
	 */
	...
	/**
	 * Create a namespace based on root document's namespace attribute + an user-defined namespace mapping
	 * @param node Root document node.
	 * @param namespaces User-defined namespace mapping. 
	 */
	...
	private void addCommonNamespaces()
	{
		...
		namespaces.put(XMLConstants.XMLNS_ATTRIBUTE,
