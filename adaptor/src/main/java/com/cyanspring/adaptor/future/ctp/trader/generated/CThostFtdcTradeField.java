...
public class CThostFtdcTradeField extends StructObject {
	...
	public String toString() {
		...
		sb.append("		TradeID = " + TradeID().getCString() + ";\n");
		...
		sb.append("		TradingRole = " + TradingRole() + ";\n");
		sb.append("		ExchangeInstID = " + ExchangeInstID().getCString() + ";\n");
		sb.append("		OffsetFlag = " + OffsetFlag() + ";\n");
		sb.append("		HedgeFlag = " + HedgeFlag() + ";\n");		
		sb.append("		Price = " + Price() + ";\n");
		sb.append("		Volume = " + Volume() + ";\n");
		sb.append("		TradeType = " + TradeType() + ";\n");
		sb.append("		TradeDate = " + TradeDate().getCString() + ";\n");
		sb.append("		TradeTime = " + TradeTime().getCString() + ";\n");
		sb.append("		PriceSource = " + PriceSource() + ";\n");
		sb.append("		TraderID = " + TraderID().getCString() + ";\n");
		sb.append("		OrderLocalID = " + OrderLocalID().getCString() + ";\n");
		sb.append("		ClearingPartID = " + ClearingPartID().getCString() + ";\n");
		sb.append("		BusinessUnit = " + BusinessUnit().getCString() + ";\n");
		sb.append("		SequenceNo = " + SequenceNo() + ";\n");
		sb.append("		TradingDay = " + TradingDay().getCString() + ";\n");
		sb.append("		SettlementID = " + SettlementID() + ";\n");
		sb.append("		BrokerOrderSeq = " + BrokerOrderSeq() + ";\n");
		sb.append("		TradeSource = " + TradeSource() + ";\n");
