...
java -ms256m -mx1024m -XX:PermSize=128m -XX:MaxPermSize=128 -Duser.timezone=GMT+8 -jar jars/cyanspring-server-2.56.jar conf/server_fdt_ib.xml > ./log/console.log &
