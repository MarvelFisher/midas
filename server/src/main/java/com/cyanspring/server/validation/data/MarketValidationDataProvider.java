...
public class MarketValidationDataProvider implements IPlugin, IQuoteExtProvider {
	private static final Logger log = LoggerFactory.getLogger(MarketValidationDataProvider.class);
	private static final String ID = "VDP-" + IdGenerator.getInstance().getNextID();
	private static final String SENDER = MarketValidationDataProvider.class.getSimpleName();
	...
	public void requestMarketSession() {
		eventManager.sendEvent(
				new MarketSessionRequestEvent(MarketValidationDataProvider.ID, MarketValidationDataProvider.SENDER, true));
	}
	...
	public void sendQuoteExtSubEvent() {
		...
		AllQuoteExtSubEvent event = new AllQuoteExtSubEvent(
				MarketValidationDataProvider.ID, MarketValidationDataProvider.SENDER);
		log.info("send AllQuoteExtSubEvent event");
