...
CREATE TABLE ANYONE.ACCOUNTS(ACCOUNT_ID VARCHAR(40) NOT NULL PRIMARY KEY, USER_ID VARCHAR(40), MARKET VARCHAR(40), 
	CASH DOUBLE, COMMISSION DOUBLE, MARGIN DOUBLE, PNL DOUBLE, ALL_TIME_PNL DOUBLE, UR_PNL DOUBLE, 
	CASH_DEPOSITED DOUBLE, ROLL_PRICE DOUBLE, UNIT_PRICE DOUBLE,
	ACTIVE BOOLEAN, CREATED TIMESTAMP, CASHAVAILABLE BOOLEAN, CURRENCY VARCHAR(10));
...
CREATE TABLE ANYONE.ACCOUNTS_DAILY(ACCOUNT_ID VARCHAR(40), USER_ID VARCHAR(40), MARKET VARCHAR(40), 
	CASH DOUBLE, COMMISSION DOUBLE, MARGIN DOUBLE, PNL DOUBLE, ALL_TIME_PNL DOUBLE, UR_PNL DOUBLE, 
	CASH_DEPOSITED DOUBLE, ROLL_PRICE DOUBLE, UNIT_PRICE DOUBLE,
	ACTIVE BOOLEAN, CREATED TIMESTAMP, CASHAVAILABLE BOOLEAN, CURRENCY VARCHAR(10), ON_DATE DATE, ON_TIME TIMESTAMP, TRADE_DATE VARCHAR(20),
...
ROUTE VARCHAR(40), LEVERAGERATE DOUBLE DEFAULT 0, COMMISSION DOUBLE DEFAULT 0, DAILYSTOPLOSS DOUBLE DEFAULT 0);     
