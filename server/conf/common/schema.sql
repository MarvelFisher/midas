...
CREATE TABLE ANYONE.ACCOUNTS(ACCOUNT_ID VARCHAR(40) NOT NULL PRIMARY KEY, USER_ID VARCHAR(40), MARKET VARCHAR(40), 
	...
	ACTIVE BOOLEAN, CREATED TIMESTAMP, CURRENCY VARCHAR(10), CASH_AVAILABLE DOUBLE DEFAULT 0);
...
CREATE TABLE ANYONE.ACCOUNTS_DAILY(ACCOUNT_ID VARCHAR(40), USER_ID VARCHAR(40), MARKET VARCHAR(40), 
	...
	CASH_AVAILABLE DOUBLE DEFAULT 0,
...
ROUTE VARCHAR(40), LEVERAGE_RATE DOUBLE DEFAULT 0, COMMISSION DOUBLE DEFAULT 0, DAILY_STOPLOSS DOUBLE DEFAULT 0);     
