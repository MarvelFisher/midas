...
CREATE TABLE ANYONE.EXECUTIONS(OBJECT_ID VARCHAR(40) NOT NULL PRIMARY KEY, SYMBOL VARCHAR(30), SIDE VARCHAR(20), QUANTITY DOUBLE, PRICE DOUBLE,
	ORDER_ID VARCHAR(40), PARENT_ID VARCHAR(40), STRATEGY_ID VARCHAR(40), EXEC_ID VARCHAR(40), MODIFIED TIMESTAMP, CREATED TIMESTAMP, SEQ_ID VARCHAR(40), SERVER_ID VARCHAR(40), TRADER VARCHAR(40), ACCOUNT VARCHAR(40), ROUTE VARCHAR(40), TRADE_DATE DATE);
...
CREATE TABLE ANYONE.OPEN_POSITIONS(POSITION_ID VARCHAR(40) NOT NULL PRIMARY KEY, USER_ID VARCHAR(40), ACCOUNT_ID VARCHAR(40),
	SYMBOL VARCHAR(40), QTY DOUBLE,	PRICE DOUBLE, PNL DOUBLE, AC_PNL DOUBLE, CREATED TIMESTAMP, MARGIN DOUBLE DEFAULT 0, TRADE_DATE DATE);
...
CREATE TABLE ANYONE.CLOSED_POSITIONS(POSITION_ID VARCHAR(80) NOT NULL PRIMARY KEY, USER_ID VARCHAR(40), 
	...
	QTY DOUBLE,	BUY_PRICE DOUBLE, SELL_PRICE DOUBLE, PNL DOUBLE, AC_PNL DOUBLE, CREATED TIMESTAMP, TRADE_DATE DATE);	
...
DROP TABLE ANYONE.EXCHANGE_ACCOUNT;
CREATE TABLE ANYONE.EXCHANGE_ACCOUNT(
	EXCHANGE_ACCOUNT_ID VARCHAR(40), 
	EXCHANGE_ACCOUNT_NAME VARCHAR(40),
	PRIMARY KEY(EXCHANGE_ACCOUNT_ID));

DROP TABLE ANYONE.EXCHANGE_SUB_ACCOUNT;
CREATE TABLE ANYONE.EXCHANGE_SUB_ACCOUNT(
	EXCHANGE_SUB_ACCOUNT_ID VARCHAR(40), 
	NAME VARCHAR(40),
	EXCHANGE_ACCOUNT_ID VARCHAR(40),
	DESCRIPTION VARCHAR(40),
	PRIMARY KEY(EXCHANGE_SUB_ACCOUNT_ID));

DROP TABLE ANYONE.ACCOUNT_POOL;
CREATE TABLE ANYONE.ACCOUNT_POOL(
	ACCOUNT VARCHAR(40), 
	INSTRUMENT_POOL_ID VARCHAR(40),
	PRIMARY KEY(ACCOUNT, INSTRUMENT_POOL_ID));
	
DROP TABLE ANYONE.INSTRUMENT_POOL;
CREATE TABLE ANYONE.INSTRUMENT_POOL(
	INSTRUMENT_POOL_ID VARCHAR(40), 
	NAME VARCHAR(40),
	EXCHANGE_SUB_ACCOUNT_ID VARCHAR(40),
	PRIMARY KEY(INSTRUMENT_POOL_ID));

DROP TABLE ANYONE.INSTRUMENT_POOL_RECORD;
CREATE TABLE ANYONE.INSTRUMENT_POOL_RECORD(
	INSTRUMENT_POOL_ID VARCHAR(40), 
	EXCHANGE_SUB_ACCOUNT_ID VARCHAR(40),
	SYMBOL VARCHAR(40),
	QTY DOUBLE DEFAULT 0,
	BUY_HELD DOUBLE DEFAULT 0,
	SELL_HELD DOUBLE DEFAULT 0,
	PRIMARY KEY(INSTRUMENT_POOL_ID,SYMBOL));
	
DROP TABLE ANYONE.USER_EXCHANGE_ACCOUNT_MAPPING;
CREATE TABLE ANYONE.USER_EXCHANGE_ACCOUNT_MAPPING(
	USER_ID VARCHAR(40), 
	EXCHANGE_SUB_ACCOUNT_ID VARCHAR(40),
	PRIMARY KEY(USER_ID,EXCHANGE_SUB_ACCOUNT_ID));
