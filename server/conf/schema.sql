...
CREATE TABLE ANYONE.TEXT_OBJECTS(OBJECT_ID VARCHAR(40), OBJECT_TYPE VARCHAR(40), LINE_NO INTEGER, 
...
CREATE TABLE ANYONE.ACCOUNTS(ACCOUNT_ID VARCHAR(40) NOT NULL PRIMARY KEY, USER_ID VARCHAR(40), MARKET VARCHAR(40), 
	...
	CASH_DEPOSITED DOUBLE, UNIT_PRICE DOUBLE,
...
CREATE TABLE ANYONE.ACCOUNTS_DAILY(ACCOUNT_ID VARCHAR(40), USER_ID VARCHAR(40), MARKET VARCHAR(40), 
	CASH DOUBLE, MARGIN DOUBLE, PNL DOUBLE, ALL_TIME_PNL DOUBLE, UR_PNL DOUBLE, 
	CASH_DEPOSITED DOUBLE, UNIT_PRICE DOUBLE,
	ACTIVE BOOLEAN, CREATED TIMESTAMP, CURRENCY VARCHAR(10), ON_DATE DATE,
...
CREATE TABLE ANYONE.OPEN_POSITIONS(POSITION_ID VARCHAR(40) NOT NULL PRIMARY KEY, USER_ID VARCHAR(40), ACCOUNT_ID VARCHAR(40),
	SYMBOL VARCHAR(40), QTY DOUBLE,	PRICE DOUBLE, PNL DOUBLE, CREATED TIMESTAMP);
...
CREATE TABLE ANYONE.ACCOUNT_SETTINGS(ACCOUNT_ID VARCHAR(40) NOT NULL PRIMARY KEY, DEFAULT_QTY DOUBLE DEFAULT NULL, STOP_LOSS_VALUE DOUBLE DEFAULT NULL);
