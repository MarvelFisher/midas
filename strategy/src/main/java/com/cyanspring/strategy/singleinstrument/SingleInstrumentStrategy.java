...
public class SingleInstrumentStrategy extends Strategy {
	...
	protected void sendStrategyUpdate() {
		SingleInstrumentStrategyUpdateEvent updateEvent = new SingleInstrumentStrategyUpdateEvent(instrument.getAccount(), null, (Instrument)instrument.clone());
	...
	public void init() throws StrategyException {
		...
		container.subscribe(QuoteEvent.class, instrument.getId(), this);
		...
		container.subscribe(UpdateChildOrderEvent.class, instrument.getId(), this);
	...
	public void uninit() {
		...
		container.unsubscribe(QuoteEvent.class, instrument.getId(), this);
		...
		container.unsubscribe(UpdateChildOrderEvent.class, instrument.getId(), this);
	...
	public ISingleInstrumentAnalyzer getAnalyzer() {
		return analyzer;
	}

	public void setAnalyzer(ISingleInstrumentAnalyzer analyzer) {
