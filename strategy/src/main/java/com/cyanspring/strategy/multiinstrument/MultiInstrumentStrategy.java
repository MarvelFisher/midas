...
public abstract class MultiInstrumentStrategy extends Strategy {
	...
	protected IRefDataManager refDataManager;
	...
	public void init() throws StrategyException {
		...
		container.subscribe(QuoteEvent.class, getId(), this);
		...
		container.subscribe(UpdateChildOrderEvent.class, getId(), this);
	...
	public void uninit() {
		...
		container.unsubscribe(QuoteEvent.class, getId(), this);
		...
		container.unsubscribe(UpdateChildOrderEvent.class, getId(), this);
	...
	public void create(Object... objects) throws StrategyException {
		setRefDataManager((IRefDataManager)objects[0]);
	...
	public void sendStrategyDataUpdate() {
		MultiInstrumentStrategyUpdateEvent update = new MultiInstrumentStrategyUpdateEvent(data.getAccount(), null, (MultiInstrumentStrategyData)data.clone()); 
