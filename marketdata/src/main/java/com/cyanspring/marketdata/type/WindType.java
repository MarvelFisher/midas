package com.cyanspring.marketdata.type;
...
public final class WindType {
    ...
    public static final int FC_INDEX = 112;
    public static final int FC_COMMODITY = 113;
    public static final int FC_INDEX_CX = 120;
    public static final int FC_COMMODITY_CX = 122;
}
