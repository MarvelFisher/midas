...
public class WindAdaptor implements IMarketDataAdaptor, IWindGateWayListener{
    ...
    public void processGateWayMessage(int datatype, String[] in_arr, HashMap<Integer, Object> inputMessageHashMap) {
        ...
        switch (datatype) {
            case WindDef.MSG_DATA_MARKET: {
                ...
                quoteMgr.addRequest(new Object[]{WindDef.MSG_DATA_MARKET, stockData.clone()});
            }
            break;
            case WindDef.MSG_DATA_INDEX: {
                ...
                quoteMgr.addRequest(new Object[]{WindDef.MSG_DATA_INDEX, indexData.clone()});
            }
            break;
            case WindDef.MSG_DATA_FUTURE: {
                ...
                quoteMgr.addRequest(new Object[]{WindDef.MSG_DATA_FUTURE, futureData.clone()});
            }
            break;
            case WindDef.MSG_DATA_TRANSACTION: {
                ...
                quoteMgr.addRequest(new Object[]{WindDef.MSG_DATA_TRANSACTION, transationData.clone()});
            }
            break;
            default:
                break;
    ...
    public void sendState(boolean on) {
        if(marketDataStateListener != null) marketDataStateListener.onState(on, this);
    }
    ...
    public void subscribeMarketData(String symbol, IMarketDataListener listener) throws MarketDataException {
        if(marketDataListener == null) marketDataListener = listener;
        if (symbol.isEmpty())
            return;
