...
public class DeleteGroupManagementEvent extends RemoteAsyncEvent{

	private static final long serialVersionUID = 1L;

	private List<GroupManagement> groupManagementList;
	
	public DeleteGroupManagementEvent(String key, String receiver,List<GroupManagement> groupManagementList) {
		super(key, receiver);
