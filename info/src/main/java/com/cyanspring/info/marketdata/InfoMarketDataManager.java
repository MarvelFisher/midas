...
public class InfoMarketDataManager implements IPlugin, IMarketDataListener,
        IMarketDataStateListener {
    private static final Logger log = LoggerFactory
            .getLogger(InfoMarketDataManager.class);
    private static final Logger quoteLog = LoggerFactory
            .getLogger(InfoMarketDataManager.class.getName() + ".QuoteLog");
...
//            subscribeToEvent(MarketSessionEvent.class, null);
    ...
    public void processQuoteSubEvent(QuoteSubEvent event) throws Exception {
        ...
        if (quote == null || quote.isStale()) {
            for (int i = 0; i < adaptors.size(); i++) {
                ...
                if (!adaptor.getState())
                    continue;
                adaptor.subscribeMarketData(symbol, InfoMarketDataManager.this);
            }
        }
    }
    ...
    public InfoMarketDataManager(List<IMarketDataAdaptor> adaptors) {
